...
#   curl -sSL https://raw.githubusercontent.com/JustSomeRuzkiAnon/smtp-tunnel-proxy/main/install.sh | sudo bash
#
# Version: 1.3.0
...
# GitHub raw URL base
GITHUB_RAW="https://raw.githubusercontent.com/JustSomeRuzkiAnon/smtp-tunnel-proxy/main"
